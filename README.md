...
iptables -A ufw-user-input -p udp -m udp --dport 8080 -j ACCEPT
```
firewall rules on the webapp machine for Tomcat (running on 8080) to allow BlueGenes queries (e.g. user login)
